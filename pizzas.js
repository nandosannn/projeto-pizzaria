let pizzaJson = [
    {id:1, name:'Mussarela', img:'images/pizza.png', price:20.19, sizes:['100g', '530g', '920g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
